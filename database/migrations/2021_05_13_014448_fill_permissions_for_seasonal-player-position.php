...
class FillPermissionsForSeasonalPlayerPosition extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSeasonalPlayerPosition constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.seasonal-player-position',
            'admin.seasonal-player-position.index',
            'admin.seasonal-player-position.create',
            'admin.seasonal-player-position.show',
            'admin.seasonal-player-position.edit',
            'admin.seasonal-player-position.delete',
            'admin.seasonal-player-position.bulk-delete',
        ]);

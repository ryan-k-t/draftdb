...
class FillPermissionsForHandType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHandType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.hand-type',
            'admin.hand-type.index',
            'admin.hand-type.create',
            'admin.hand-type.show',
            'admin.hand-type.edit',
            'admin.hand-type.delete',
            'admin.hand-type.bulk-delete',
        ]);

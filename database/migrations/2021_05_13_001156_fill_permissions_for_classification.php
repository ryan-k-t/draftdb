...
class FillPermissionsForClassification extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForClassification constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.classification.index',
            'admin.classification.create',
            'admin.classification.show',
            'admin.classification.edit',
            'admin.classification.delete',
            'admin.classification.bulk-delete',
        ]);

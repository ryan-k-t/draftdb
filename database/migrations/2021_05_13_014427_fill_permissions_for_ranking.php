...
class FillPermissionsForRanking extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRanking constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ranking',
            'admin.ranking.index',
            'admin.ranking.create',
            'admin.ranking.show',
            'admin.ranking.edit',
            'admin.ranking.delete',
            'admin.ranking.bulk-delete',
        ]);

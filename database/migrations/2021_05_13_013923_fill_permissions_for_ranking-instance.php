...
class FillPermissionsForRankingInstance extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRankingInstance constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ranking-instance',
            'admin.ranking-instance.index',
            'admin.ranking-instance.create',
            'admin.ranking-instance.show',
            'admin.ranking-instance.edit',
            'admin.ranking-instance.delete',
            'admin.ranking-instance.bulk-delete',
        ]);

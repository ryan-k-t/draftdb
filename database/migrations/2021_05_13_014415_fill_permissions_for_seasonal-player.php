...
class FillPermissionsForSeasonalPlayer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSeasonalPlayer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.seasonal-player',
            'admin.seasonal-player.index',
            'admin.seasonal-player.create',
            'admin.seasonal-player.show',
            'admin.seasonal-player.edit',
            'admin.seasonal-player.delete',
            'admin.seasonal-player.bulk-delete',
        ]);

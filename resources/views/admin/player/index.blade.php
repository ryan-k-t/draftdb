                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'preferred_name'">{{ trans('admin.player.columns.preferred_name') }}</th>
                                        <th is='sortable' :column="'date_of_birth'">{{ trans('admin.player.columns.date_of_birth') }}</th>
